...
public class GiaiTriActivity extends AppCompatActivity {
    ...
    private void action() {
        ...
        CustomListTruyen customListTruyen = new CustomListTruyen(GiaiTriActivity.this, R.layout.item_truyen, truyens);
        ...
        lvCoTichVietNam.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getBaseContext(), TinActivity.class);
        ...
        lvCoTichVietNam.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                final AlertDialog.Builder alert = new AlertDialog.Builder(GiaiTriActivity.this);
                alert.setTitle("Lưu!!!");
                ...
                alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dbManager = new DBManager(GiaiTriActivity.this);
                        dbManager.addTruyen(truyens.get(i));
                        Toast.makeText(GiaiTriActivity.this, "Thêm thành công!!!", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        navCoTichVietNam.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_trangchu) {
                    Intent intent1 = new Intent(GiaiTriActivity.this, DocTruyenActivity.class);
                    startActivity(intent1);

                } else if (id == R.id.nav_tindaluu) {
                    Intent intent = new Intent(GiaiTriActivity.this, TruyenDaLuuActivity.class);
                    startActivity(intent);

                } else if (id == R.id.nav_truyen_thieu_nhi) {

                    Intent intent = new Intent(GiaiTriActivity.this, DuLichActivity.class);
                    startActivity(intent);

                } else if (id == R.id.nav_truyen_co_tich_viet_nam) {
                    Intent intent = new Intent(GiaiTriActivity.this, GiaiTriActivity.class);
                    startActivity(intent);
