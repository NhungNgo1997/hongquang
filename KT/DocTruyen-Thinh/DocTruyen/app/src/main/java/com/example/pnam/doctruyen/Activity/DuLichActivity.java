...
public class DuLichActivity extends AppCompatActivity {
    ...
    private void action() {
        ...
        CustomListTruyen customListTruyen = new CustomListTruyen(DuLichActivity.this, R.layout.item_truyen, truyens);
        ...
        lvTruyenThieuNhi.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                final AlertDialog.Builder alert = new AlertDialog.Builder(DuLichActivity.this);
                alert.setTitle("Lưu!!!");
                ...
                alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dbManager = new DBManager(DuLichActivity.this);
                        dbManager.addTruyen(truyens.get(i));
                        Toast.makeText(DuLichActivity.this, "Thêm thành công!!!", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        navTruyenThieuNhi.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_trangchu) {
                    Intent intent1 = new Intent(DuLichActivity.this, DocTruyenActivity.class);
                    startActivity(intent1);

                } else if (id == R.id.nav_tindaluu) {
                    Intent intent = new Intent(DuLichActivity.this, TruyenDaLuuActivity.class);
                    startActivity(intent);

                } else if (id == R.id.nav_truyen_thieu_nhi) {

                    Intent intent = new Intent(DuLichActivity.this, DuLichActivity.class);
                    startActivity(intent);

                } else if (id == R.id.nav_truyen_co_tich_viet_nam) {
                    Intent intent = new Intent(DuLichActivity.this, GiaiTriActivity.class);
                    startActivity(intent);
