    ...
    private void action() {
        ...
        lvTtruyendaluu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TruyenDaLuuActivity.this, TinTucDaLuuActivity.class);
        ...
        navTruyendaluu.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_trangchu) {
                    ...
                    Intent intent = new Intent(TruyenDaLuuActivity.this, DuLichActivity.class);
                    startActivity(intent);
                } else if (id == R.id.nav_truyen_co_tich_viet_nam) {
                    Intent intent = new Intent(TruyenDaLuuActivity.this, GiaiTriActivity.class);
                    startActivity(intent);
