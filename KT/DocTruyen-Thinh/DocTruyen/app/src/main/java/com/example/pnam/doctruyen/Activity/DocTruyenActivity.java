    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Email: Đặng Hồng Quang", Snackbar.LENGTH_LONG)
...
//                Toast.makeText(DocTruyenActivity.this, truyens.get(position).toString(), Toast.LENGTH_SHORT).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_trangchu) {
            ...
            Intent intent = new Intent(DocTruyenActivity.this,DuLichActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_truyen_co_tich_viet_nam) {
            Intent intent = new Intent(DocTruyenActivity.this, GiaiTriActivity.class);
            startActivity(intent);
